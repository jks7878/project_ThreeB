...
public class BookingVO {
   ...
   public BookingVO(String member_id, int house_id, String house_title, String house_location, Date checkin,
         Date checkout, int booking_total, String booking_detail, int booking_amount, String memo) {
      super();
